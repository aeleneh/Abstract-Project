...
const HelpPage = () => {
  ...
  return (
   ...
   <section className='bg-[#dadbf1] flex justify-center items-center flex-col px-6 py-16 md:py-32 md:px-20 w-full'>
    ...
    className='text-base md:text-md border-[1px] border-black rounded-md py-4
    md:py-6 pl-4 pr-12 w-full outline-none shadow-xl font-light'/>
    <button className='absolute inset-y-0 right-0 flex items-center pr-4 cursor-pointer touch-manipulation min-w-[44px]'
